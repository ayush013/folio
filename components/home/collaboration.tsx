...
const Collaboration = ({ clientHeight }) => {
    ...
    return (
        <section className='w-full relative select-none' ref={targetSection}>
            <div className={(clientHeight > 650 ? 'pt-24 pb-36' : 'pt-36 pb-48') + ' 2xl:container mx-auto xl:px-20 md:px-12 px-4 flex flex-col gap-y-8'}>
                ...
                <p className='opacity-20 text-5xl md:text-7xl font-bold whitespace-nowrap ui-right transform-gpu'>{Array(5).fill(' Frontend Development  Motion Graphics ').reduce((str, el) => str.concat(el), '')} </p>
            </div>
            <style jsx global>{`
            .text-strong {
