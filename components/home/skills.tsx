            ...
            <div className='2xl:container mx-auto py-12 xl:px-20 md:px-12 px-4 flex flex-col justify-center'>
                ...
                <div className="flex flex-col skills-wrapper">
                    <div className='flex flex-col'>
                        ...
                        <h1 className='text-5xl font-bold text-gradient seq w-fit mt-2'>My Skills</h1>
                        <h2 className='text-2xl md:max-w-2xl w-full seq mt-2'>I like to take responsibility to craft aesthetic user experience using modern frontend architecture. </h2>
                    </div>
                    <div className='mt-10'>
